...
void testRemoveIterator(){
    ...
    assert(m.size() == 12);
    MultiMapIterator mmit = m.iterator();
    TElem elem = mmit.getCurrent();
    assert(elem.first == 90);
    assert(elem.second == 90);
    elem = mmit.remove();
    assert(elem.first == 90);
    assert(elem.second == 90);
    elem = mmit.getCurrent();
    assert(elem.first == 60);
    assert(elem.second == 60);
    elem = mmit.remove();
    assert(elem.first == 60);
    assert(elem.second == 60);
    elem = mmit.getCurrent();
    assert(elem.first == 0);
    assert(elem.second == 0);
    elem = mmit.remove();
    assert(elem.second == 0);
    assert(elem.first == 0);
    assert(mmit.valid() == false);
}
