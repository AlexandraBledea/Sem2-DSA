...
void testPrevious(Relation r)
{
    ...
    sm.add(2,3);
    sm.add(4,5);
    SMIterator li = sm.iterator();
    assert(li.getCurrent().first == 1);
    assert(li.getCurrent().second == 1);
    li.next();
    assert(li.getCurrent().first == 2);
    assert(li.getCurrent().second == 3);
    li.next();
    assert(li.getCurrent().first == 4);
    assert(li.getCurrent().second == 5);
    li.previous();
    assert(li.getCurrent().first == 2);
    assert(li.getCurrent().second == 3);
    li.previous();
